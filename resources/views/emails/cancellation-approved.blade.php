...
<head>
    ...
    <title>{{ __('messages.email_cancellation_approved_heading') }}</title>
</head>
        ...
        <tr>
            <td align="center" style="padding: 40px 0;">
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <!-- Header -->
                    <tr>
                        <td style="background-color: #dc2626; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">{{ __('messages.email_cancellation_approved_heading') }}</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px; color: #374151; font-size: 16px; line-height: 1.6;">
                                {!! __('messages.email_cancellation_approved_body') !!}
                            </p>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f9fafb; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 25px;">
                                        <h2 style="margin: 0 0 20px; color: #111827; font-size: 18px; font-weight: bold;">{{ __('messages.email_cancellation_approved_details_title') }}</h2>
                                        ...
                                        <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0;">
                                                    <span style="display: inline-block; padding: 4px 12px; background-color: #fee2e2; color: #991b1b; font-size: 12px; font-weight: 600; border-radius: 12px;">{{ __('messages.email_status_cancelled') }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin: 0 0 20px; color: #374151; font-size: 16px; line-height: 1.6;">
                                {{ __('messages.email_cancellation_approved_rebook') }}
                            </p>
                            ...
                            <table role="presentation" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/appointments') }}" style="display: inline-block; padding: 14px 32px; background-color: #dc2626; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">{{ __('messages.email_cancellation_approved_cta') }}</a>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="margin: 30px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                                {{ __('messages.email_cancellation_approved_questions') }}
                            </p>
                        </td>
                    </tr>
