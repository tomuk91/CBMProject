...
<head>
    ...
    <title>{{ __('messages.email_rescheduled_heading') }}</title>
</head>
        ...
        <tr>
            <td align="center" style="padding: 40px 0;">
                <table role="presentation" style="width: 600px; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <!-- Header -->
                    <tr>
                        <td style="background-color: #2563eb; background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: bold;">{{ __('messages.email_rescheduled_heading') }}</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px; color: #374151; font-size: 16px; line-height: 1.6;">
                                {{ __('messages.email_rescheduled_body') }}
                            </p>
                            
                            <!-- Appointment Details Box -->
                            <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #f0f9ff; border-radius: 8px; margin: 30px 0; border: 1px solid #bae6fd;">
                                <tr>
                                    <td style="padding: 25px;">
                                        <h2 style="margin: 0 0 20px; color: #111827; font-size: 18px; font-weight: bold;">{{ __('messages.email_rescheduled_new_details') }}</h2>
                            ...
                            <table role="presentation" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/dashboard') }}" style="display: inline-block; padding: 14px 32px; background-color: #2563eb; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">{{ __('messages.email_rescheduled_cta') }}</a>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="margin: 30px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                                {{ __('messages.email_rescheduled_questions') }}
                            </p>
                        </td>
                    </tr>
