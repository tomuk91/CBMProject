...
<head>
    ...
    <title>500 — {{ config('app.name', 'CBM Auto') }}</title>
    <script>
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="text-center max-w-md">
            <p class="text-7xl font-bold text-red-600">500</p>
            <h1 class="mt-4 text-2xl font-bold text-gray-900 dark:text-white">{{ __('messages.error_500_title') }}</h1>
            <p class="mt-3 text-gray-600 dark:text-gray-400">{{ __('messages.error_500_description') }}</p>
