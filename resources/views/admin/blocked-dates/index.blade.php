<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <x-help-hint :text="__('messages.help_blocked_dates')" position="bottom" />
        </h2>
    </x-slot>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-4 lg:px-6 space-y-6">
            ...
            @if (session('warning'))
                <div x-data="{ show: true }" x-show="show" x-transition
                     class="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 text-yellow-700 dark:text-yellow-300 px-4 py-3 rounded-xl flex items-center justify-between shadow-sm">
                    <div class="flex items-center">
                    ...
                    <button @click="show = false" class="text-yellow-500 hover:text-yellow-700 dark:hover:text-yellow-300">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
                    </button>
                </div>
            @endif
            ...
            {{-- Admin Guidelines --}}
            <div x-data="{ open: false }" data-tour="blocked-guidelines" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div data-tour="blocked-form" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('admin.blocked-dates.store') }}" class="flex flex-col sm:flex-row sm:items-end gap-4">
                    ...
                    <div class="flex-1">
                        <label for="date_to" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('messages.blocked_date_range_to') }}</label>
    ...
    @include('admin.partials.tour', [
        'tourPage' => 'blocked-dates',
        'tourSteps' => [
            [
                'target' => null,
                'title' => __('messages.tour_blocked_welcome_title'),
                'description' => __('messages.tour_blocked_welcome_description'),
                'icon' => '<svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M13.477 14.89A6 6 0 015.11 6.524l8.367 8.368zm1.414-1.414L6.524 5.11a6 6 0 018.367 8.367zM18 10a8 8 0 11-16 0 8 8 0 0116 0z" clip-rule="evenodd"/></svg>',
                'position' => 'center',
            ],
            [
                'target' => '[data-tour="blocked-guidelines"]',
                'title' => __('messages.tour_blocked_guidelines_title'),
                'description' => __('messages.tour_blocked_guidelines_description'),
            ...
            [
                'target' => '[data-tour="blocked-form"]',
                'title' => __('messages.tour_blocked_form_title'),
                'description' => __('messages.tour_blocked_form_description'),
            ...
            [
                'target' => null,
                'title' => __('messages.tour_blocked_complete_title'),
                'description' => __('messages.tour_blocked_complete_description'),
