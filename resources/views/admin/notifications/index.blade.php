<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                ...
                <x-help-hint :text="__('messages.help_notifications')" position="bottom" />
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-4 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-4 lg:px-6 space-y-6">
                {{-- Header --}}
                <div data-tour="notifications-header" class="bg-gradient-to-r from-red-600 to-red-700 dark:from-red-700 dark:to-red-800 rounded-xl shadow-lg overflow-hidden">
                    <div class="p-8">
                ...
                {{-- Notifications List --}}
                <div data-tour="notifications-list" class="space-y-3">
    ...
    @include('admin.partials.tour', [
        ...
        'tourSteps' => [
            [
                'target' => null,
                'title' => __('messages.tour_notifications_welcome_title'),
                'description' => __('messages.tour_notifications_welcome_description'),
                'icon' => '<svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/></svg>',
                'position' => 'center',
            ],
            [
                'target' => '[data-tour="notifications-header"]',
                'title' => __('messages.tour_notifications_header_title'),
                'description' => __('messages.tour_notifications_header_description'),
                'icon' => '<svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/></svg>',
                'position' => 'bottom',
            ],
            [
                'target' => '[data-tour="notifications-list"]',
                'title' => __('messages.tour_notifications_list_title'),
                'description' => __('messages.tour_notifications_list_description'),
            ...
            [
                'target' => null,
                'title' => __('messages.tour_notifications_complete_title'),
                'description' => __('messages.tour_notifications_complete_description'),
