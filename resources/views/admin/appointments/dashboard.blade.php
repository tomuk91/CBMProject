    ...
    @include('admin.partials.tour', [
        ...
        'tourSteps' => [
            ...
            [
                ...
                'title' => __('messages.tour_sidebar_title'),
                'description' => __('messages.tour_sidebar_description'),
                'icon' => '<svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"/></svg>',
                'position' => 'right',
            ],
            [
                'target' => '[data-tour="sidebar-appointments"]',
                'title' => __('messages.tour_sidebar_appointments_title'),
                'description' => __('messages.tour_sidebar_appointments_description'),
            ...
            [
                ...
                'title' => __('messages.tour_sidebar_reports_title'),
                'description' => __('messages.tour_sidebar_reports_description'),
                'icon' => '<svg class="w-7 h-7 text-red-600 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20"><path d="M2 11a1 1 0 011-1h2a1 1 0 011 1v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5zM8 7a1 1 0 011-1h2a1 1 0 011 1v9a1 1 0 01-1 1H9a1 1 0 01-1-1V7zM14 4a1 1 0 011-1h2a1 1 0 011 1v12a1 1 0 01-1 1h-2a1 1 0 01-1-1V4z"/></svg>',
                'position' => 'right',
            ],
            [
                'target' => '[data-tour="sidebar-system"]',
                'title' => __('messages.tour_sidebar_system_title'),
                'description' => __('messages.tour_sidebar_system_description'),
